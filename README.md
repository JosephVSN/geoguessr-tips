...
## Bolivia
* Lots of signs for Mas (political party) or Evo Morales (previous president from coverage era - I haven't seen any signs for Luis Arce)
...
## Argentina
### Road Signs
* National highways have kilometer markers with a black header and white body - header says "RN #"
* Provincial roads have the same markers as natl. highways, but instead say "RP #"
### Road Markings
* Double yellow solid lines or single yellow with white dashed or white dashed only
### Poles & Bollards
...
### Trash Bins
### Agriculture & Land Features
* Mountains to the left of the country
* Parana Pine - Branches at the top that curve upwards and look like little shrubs
    * Similar to "Monkey Puzzle Tree" only found in west Neuquen prov. - less umbrella-like
* Palm Trees in Northern Argentina
* Poplar trees (tall shrub-looking)
### Region-specific

## Uruguay
### Road Signs
### Road Markings
* White road lines with a white center between two yellow lines
* White plates with blue header
* White, wooden sign posts
### Poles & Bollards
* White/yellow bollards
* White painted wooden sign posts
* Concrete electricity poles
### Google Car
### License Plates
* White background, blue text, with sigil in center and "Uruguay" written on bottom
### Trash Bins
### Agriculture & Land Features
* Flat, open grassland, interspersed with trees/rocks/streams
### Region-specific
...
### License Plates
### Trash Bins
* Green garbage bins - **not sure if this is real meta but it seems to always be there**
### Agriculture & Land Features
### Region-specific
...
## Bhutan
### Road Signs
* Small white stones that look like gravestones 
### Road Markings
### Poles & Bollards
* Small white stone poles with yellow squares
* Short rocks as guardrails
### Google Car
### License Plates
